...
def main(params):
    ...
    if params['filter_score']:
        print
        'Mean Meteor Score %.2f' % (np.array(meteor_score).mean())
    print
    'Original data'
    print
    '-------------'
    print
    'Doc accuracy is %s : %.2f, %d , %s : %.2f, %d' % (
    ix_to_auth[0], (doc_accuracy[0] / doc_count[0]), doc_count[0], ix_to_auth[1], (doc_accuracy[1] / doc_count[1]),
    doc_count[1])
    ...
    '-----------------'
    print
    'Sent accuracy is %s : %.2f , %d,  %s : %.2f, %d' % (
    ix_to_auth[0], (sent_accuracy[0] / sent_count[0]), sent_count[0], ix_to_auth[1], (sent_accuracy[1] / sent_count[1]),
    sent_count[1])
    ...
    '-----------------'
    print
    'Sent accuracy is %s : %.2f , %s : %.2f' % (
    ix_to_auth[0], (sent_accuracy_trans[0] / sent_count[0]), ix_to_auth[1], (sent_accuracy_trans[1] / sent_count[1]))
